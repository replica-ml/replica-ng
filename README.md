...
[![Angular build](https://github.com/SamuelMarks/replica-ng/actions/workflows/main.yml/badge.svg)](https://github.com/SamuelMarks/replica-ng/actions/workflows/main.yml)
...
## Deploy distribution
Clone [replica-ng-dist](https://github.com/SamuelMarks/replica-ng-dist) one directory above, then:

    rm -rf dist; ng build --prod && d=../replica-ng-dist && rm -rf "$d/dist" && mv "$PWD/dist/${PWD##*/}/" "$d/dist" && cd "$d" && (git add .; git status) || ( >&2 echo BUILD FAILED )
